    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الجداول' : 'Orders'"
        >
          <template v-slot:icon>
            <i class="fa fa-box text-warning text-sm opacity-10"></i>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الفواتیر' : 'Management'"
        >
          <template v-slot:icon>
            <i class="fa fa-user-cog text-warning text-sm opacity-10"></i>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الواقع الافتراضي' : 'Stock'"
        >
          <template v-slot:icon>
            <i class="fa fa-warehouse text-info text-sm opacity-10"></i>
