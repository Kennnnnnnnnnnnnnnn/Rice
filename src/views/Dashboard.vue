  ...
  <div class="py-4 container-fluid">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="row">
          <!-- Changed from col-lg-7 to col-lg-8 to make chart wider -->
          <div class="col-lg-15 mb-lg">
            <!-- line chart -->
          ...
          <!-- Changed from col-lg-5 to col-lg-4 to maintain 12-column grid -->
          <div class="col-lg-4">
            <carousel />
          </div>
        </div>
        <div class="row mt-4">
          <!-- Changed from col-lg-7 to col-lg-8 to match above -->
